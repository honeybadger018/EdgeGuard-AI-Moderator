# 🛡️ EdgeGuard AI-Moderator

> **Zero-Latency, On-Premise Content Moderation & RAG Pipeline**

[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![Python 3.8+](https://img.shields.io/badge/python-3.8+-blue.svg)](https://www.python.org/downloads/)
[![Hardware](https://img.shields.io/badge/Hardware-Lightweight_%7CSystem-success.svg)](#hardware-efficiency)
...
1. 🚨 **Data Privacy Risks (Compliance):** Sending user-generated content (UGC) to third-party APIs violates strict data residency laws and risks Personally Identifiable Information (PII) leaks.
...
* ⚡ Runs efficiently on consumer-grade hardware (sub-Minimum VRAM).
